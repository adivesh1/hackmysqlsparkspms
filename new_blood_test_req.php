...
<html>
	<head>
		<title>New Blood Test Req</title>
...
<body><div id="main">
	<div id="header">
			...
			<form action="new_blood_test_req.php" method = 'post'>
			     <input class="button" type="submit" name = "add_new_bill"value='New Blood Test' DISABLE></button></form>
			<form action="new_bill.php" method = 'post'>
				<input class="button" type="submit" name = "add_new_bill"value='Add New Bill'></button></form>
			</div>
			</div>
		<form method = "post" action="update_patient_blood_test_bill.php">
